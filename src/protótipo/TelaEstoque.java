...
public class TelaEstoque extends javax.swing.JDialog {
  String[][] data = new String[][] {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int adiciona = Integer.parseInt(jTextField1.getText());
        System.out.println(adiciona);
        adicionarEstoque(adiciona);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int remover = Integer.parseInt(jTextField1.getText());
        System.out.println(remover);
        removerEstoque(remover);
    }//GEN-LAST:event_jButton2ActionPerformed
    
    private void adicionarEstoque(int add){
        int anterior = Integer.parseInt((String) jTable1.getValueAt(jTable1.getSelectedRow(), 2));
        int linha = jTable1.getSelectedRow();
        String novo = String.valueOf(add+anterior);
        jTable1.setValueAt(novo, linha, 2);
    }
    private void removerEstoque(int remover){
        int anterior = Integer.parseInt((String) jTable1.getValueAt(jTable1.getSelectedRow(), 2));
        int linha = jTable1.getSelectedRow();
        String novo = String.valueOf(anterior-remover);
        jTable1.setValueAt(novo, linha, 2);
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaEstoque dialog = new TelaEstoque();
